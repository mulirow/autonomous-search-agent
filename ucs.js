class UniformCostSearch extends Search{
    ...
    ucs(startRow, startCol, target) {    
        // Add the start node to the priority queue with cost 0
        this.pq.enqueue([startRow, startCol], this.matrix[startRow][startCol]);
        ...
        while (!this.pq.isEmpty()) {
            ...
            for (let i = 0; i < neighbors.length; i++) {
                ...
                let cost = this.matrix[neighborRow][neighborCol];
    ...
    setPath(startPoint, endPoint){
        ...
        this.neighborsList = [];
        this.queue = [];
        this.agentPath = this.ucs(startPoint[0], startPoint[1], endPoint);
    }
}